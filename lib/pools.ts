...
export const poolColors: PoolColor[] = [
  {
    name: 'Bahama Blue',
    modelImage: '/models-colors/bahama-blue/bahama-blue-compressed-1024x972.webp',
    colorChip: '/models-colors/bahama-blue/Bahama-Blue-Water-Swatch-compressed.webp',
    referenceImages: [
  ...
  },
  {
    ...
    colorChip: '/models-colors/caribbean-blue/caribbean-blue-water-graphic-compressed.webp',
    referenceImages: [
  ...
  },
  {
    ...
    colorChip: '/models-colors/sky-blue/sky-blue-water-color-compressed.webp',
    referenceImages: [
  ...
  },
  {
    ...
    colorChip: '/models-colors/white-ivory/White-Ivory-Water-Color.webp',
    referenceImages: [
